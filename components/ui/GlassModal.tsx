...
export default function GlassModal({ open, title, children, onClose, hideClose }: { open: boolean, title: string, children: React.ReactNode, onClose: () => void, hideClose?: boolean }) {
  if (!open) return null
  return (
