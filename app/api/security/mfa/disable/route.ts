...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    if (orgId) await logAuditEvent({ orgId, actorUserId: actor, actorIp: ip || undefined, actorUserAgent: ua, eventType: 'mfa.disabled', entityType: 'user', entityId: userId, metadata: { method: s?.mfaType } })
  } catch {}
